...
#define MQTTCLIENTID    "ptest"
#define MQTTUSERNAME    "pub_client"
#define MQTTPASSWORD    "123456"
#define MQTTSUBTOPIC 	"mqtttls"
#define MQTTSUBTOPIC1 	"MQTTSUBTOPIC1"
#define MQTTPUBTOPIC 	"mqtttls"
...
typedef struct {
	void* socket_info;
	int (*send)( ssl_context *ssl, const unsigned char *buf, size_t len );
	// Connection info
	char clientid[50];
	// Auth fields
...
extern mqtt_broker_handle_t TRBroker;
 ...
 * @retval -1 On IO error.
 */
//int mqtt_publish_with_qos(mqtt_broker_handle_t* broker, const char* topic, const char* msg, uint8 retain, uint8 qos, uint16* message_id);
